...
<header id="header">
    <nav class="navbar">
      ...
      <ul class="nav-content">
        ...
        <li>
          <a id="theme-toggle" class="theme-toggle" title="Switch dark and light theme" href="#" onclick="themeToggle();return false;">
        ...
        <li class="menu-toggle">
          <button id="menu-toggle" aria-label="menu toggle" onclick="document.getElementById('side-menu').classList.add('show');">
      ...
      <div class="side-menu" id="side-menu">
        <button aria-label="close menu" class="close-menu" id="close-menu" onclick="document.getElementById('side-menu').classList.remove('show');"><svg height="13" width="13"><use href="/icons/icons8.svg#close-icon"></use></svg></button>
      ...
      <div class="domain-section-content">
        <div class="domain-header">
          <div class="name-icon-content">
            ...
            <span class="domain-name">duopan.fun</span>
          </div>
          <a rel="nofollow" href="/domain/duopan.fun/backlink?hash=377adc" onclick="addD(this)" target="_blank" class="white-bid-btn">
      ...
      <div class="main-intro-content">
        <section class="domain-profile-data">
            ...
            <span class="profile-data-heading-text">
              Domain Profile for <strong>duopan.fun</strong>
            </span>
            ...
            <div class="domain-profile">
              <div class="profile-box">
                ...
                <ul class="profile-box-list">
                  ...
                  <li>
                    <span>TLD</span>
                    <span class="information">fun</span>
                  </li>
                  <li>
              ...
              <div class="profile-box">
                ...
                <ul class="profile-box-list">
                  <li>
                    ...
                    <span class="information">30/05/2024</span>
                  </li>
                  <li>
                  ...
                  <li>
                    ...
                    <span class="information">648</span>
                  </li>
                  <li>
    ...
    <div id="ad-scroll-point" class="myadpos"></div>
            ...
            <div class="profile-box grid-layout">
              ...
              <div class="domain-list">
                ...
                <div class="domain-list-row ">
                  <span><a href="/domain/panpan.fun">panpan.fun</a></span>
                  <span class="price">1988 USD</span>
                  <a rel="nofollow" href="/domain/panpan.fun/backlink?hash=a356bf" onclick="addD(this)" target="_blank" class="domain-list-bid-btn">
                    Add to Cart on Godaddy                  </a>
                </div>
                <div class="domain-list-row ">
                  <span><a href="/domain/doubleu.casino">doubleu.casino</a></span>
                  <span class="price">8 USD</span>
                  <a rel="nofollow" href="/domain/doubleu.casino/backlink?hash=b8d264" onclick="addD(this)" target="_blank" class="domain-list-bid-btn">
                    Bid (Dyna)                  </a>
                </div>
                <div class="domain-list-row ">
                  <span><a href="/domain/2pan.com">2pan.com</a></span>
                  <span class="price">4995 USD</span>
                  <a rel="nofollow" href="/domain/2pan.com/backlink?hash=68e4c9" onclick="addD(this)" target="_blank" class="domain-list-bid-btn">
                    Add to Cart on Godaddy                  </a>
                </div>
                <div class="domain-list-row ">
                  <span><a href="/domain/expan.fun">expan.fun</a></span>
                  <span class="price">100 USD</span>
                  <a rel="nofollow" href="/domain/expan.fun/backlink?hash=ec6087" onclick="addD(this)" target="_blank" class="domain-list-bid-btn">
                    Buy Now on GoDaddy                  </a>
                </div>
                <div class="domain-list-row ">
                  <span><a href="/domain/twopandas.com">twopandas.com</a></span>
                  <span class="price">15050 USD</span>
                  <a rel="nofollow" href="/domain/twopandas.com/backlink?hash=9cc617" onclick="addD(this)" target="_blank" class="domain-list-bid-btn">
                    Add to Cart on Godaddy                  </a>
                </div>
                <div class="domain-list-row ">
                  <span><a href="/domain/saipan.fun">saipan.fun</a></span>
                  <span class="price">9999 USD</span>
                  <a rel="nofollow" href="/domain/saipan.fun/backlink?hash=232be7" onclick="addD(this)" target="_blank" class="domain-list-bid-btn">
                    Add to Cart on Godaddy                  </a>
                </div>
                <div class="domain-list-row ">
                  <span><a href="/domain/panpan.xyz">panpan.xyz</a></span>
                  <span class="price">2988 USD</span>
                  <a rel="nofollow" href="/domain/panpan.xyz/backlink?hash=9c4e3d" onclick="addD(this)" target="_blank" class="domain-list-bid-btn">
                    Add to Cart on Godaddy                  </a>
                </div>
                <div class="domain-list-row ">
                  <span><a href="/domain/duopan.fun">duopan.fun</a></span>
                  <span class="price">100 USD</span>
                  <a rel="nofollow" href="/domain/duopan.fun/backlink?hash=377adc" onclick="addD(this)" target="_blank" class="domain-list-bid-btn">
                    Buy Now on GoDaddy                  </a>
                </div>
...
<section class="benefits-section">
    ...
    <div class="benefits-content">
      ...
      <div class="registrar-data-container">
        ...
        <div class="domain-card">
          ...
          <a rel="nofollow" href="/domain/duopan.fun/backlink?hash=377adc" onclick="if (typeof(addD)=='function') addD(this)" target="_blank" class="bid-on-btn">
            Buy Now on GoDaddy          </a>
        </div>
  ...
  <section class="faq-section">
      ...
      <div class="domain-intro-section">
        <div class="domain-section-content">
          <div class="domain-header">
            ...
            <a rel="nofollow" href="/domain/duopan.fun/backlink?hash=377adc" onclick="addD(this)" target="_blank" class="bid-on-btn">
    ...
    <div class="search-bar-section" id="updated-search-bar-2">
      <form action="/search" method="post" class="updated-search-bar">
        <input type="hidden" name="_csrf" value="L_-e0e6kYSWEtK-tchBcqk0wj-Oej4sjZJ0mfQmyUHIWzaeAuclWZ8bT2JULWw_fJwfFss_m42YG734OQ4U0Gg==" />
  ...
  <div class="rotating-cards-track" id="r-cards">
    ...
    <div class="rotating-card">
      ...
      <div class="rotating-card-item">
        <a class="site-link" href="#">votetruth.com</a>
        <span class="sold-price">$404 USD</span>
      </div>
    </div>
    ...
    <div class="rotating-card">
      ...
      <div class="rotating-card-item">
        <a class="site-link" href="#">carnahanlandscaping.com</a>
        <span class="sold-price">$666 USD</span>
      </div>
    </div>
    ...
    <div class="rotating-card">
      ...
      <div class="rotating-card-item">
        <a class="site-link" href="#">plxpharma.com</a>
        <span class="sold-price">$1126 USD</span>
      </div>
    </div>
    ...
    <div class="rotating-card">
      ...
      <div class="rotating-card-item">
        <a class="site-link" href="#">charlesshaughnessy.com</a>
        <span class="sold-price">$566 USD</span>
      </div>
    </div>
    ...
    <div class="rotating-card">
      ...
      <div class="rotating-card-item">
        <a class="site-link" href="#">kitchentable.org</a>
        <span class="sold-price">$1595 USD</span>
      </div>
    </div>
...
<div class="domain-action-bar hidden-in-web">
      <a class="domain-action-button white-bid-btn" rel="nofollow" href="/domain/duopan.fun/backlink?hash=377adc" onclick="addD(this)" target="_blank">Buy Now on GoDaddy</a>
</div>
...
<script type="application/ld+json">
{
 ...
 "description": "Buy duopan.fun, a premium expired fun domain  on GoDaddy via ExpiredDomains.com.",
 "offers": {
  "@type": "Offer",
  "url": "https://expireddomains.com/domain/duopan.fun",
  "price": "100",
  "priceCurrency": "USD","priceValidUntil":"2025-08-17",   "availability": "https://schema.org/InStock",
    ...
    <div class="footer-data-container">
        ...
        <section class="links-section">
            <div class="social-media-links">
                <button
                  onclick="window.open('https://www.facebook.com/expireddomainscom/', '_blank')"
                ...
                <button
                  onclick="window.open('https://www.instagram.com/expireddomainscom/', '_blank')"
                ...
                <button
                  onclick="window.open('https://x.com/ExpiredDomainHQ', '_blank')"
                ...
                <button
                  onclick="window.open('https://www.youtube.com/@ExpiredDomainscom', '_blank')"
                ...
                <button
                  onclick="window.open('https://www.tiktok.com/@expireddomainscom', '_blank')"
                ...
                <button
                  onclick="window.open('https://www.linkedin.com/company/expireddomainscom', '_blank')"
...
i.alt="virtua";i.src = "/domain/duopan.fun/virtua";
...
<script>(function(){function c(){var b=a.contentDocument||a.contentWindow.document;if(b){var d=b.createElement('script');d.innerHTML="window.__CF$cv$params={r:'a1379fddac6c092d',t:'MTc4Mjc2NDM0OQ=='};var a=document.createElement('script');a.src='/cdn-cgi/challenge-platform/scripts/jsd/main.js';document.getElementsByTagName('head')[0].appendChild(a);";b.getElementsByTagName('head')[0].appendChild(d)}}if(document.body){var a=document.createElement('iframe');a.height=1;a.width=1;a.style.position='absolute';a.style.top=0;a.style.left=0;a.style.border='none';a.style.visibility='hidden';document.body.appendChild(a);if('loading'!==document.readyState)c();else if(window.addEventListener)document.addEventListener('DOMContentLoaded',c);else{var e=document.onreadystatechange||function(){};document.onreadystatechange=function(b){e(b);'loading'!==document.readyState&&(document.onreadystatechange=e,c())}}}})();</script></body>
</html>
